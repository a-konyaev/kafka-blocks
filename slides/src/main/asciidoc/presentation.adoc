...
@Service
@Scope("prototype")
public class TagUnlinkProcessor
    extends BaseTerminalEventProcessor<TagLinkEvent> {
...
@Service
@Scope("prototype")
public class ObjectCoordsProcessor
        extends BaseTransformingEventProcessor<TrackableObjectMovementEvent, TrackableObjectCoordsEvent> {
