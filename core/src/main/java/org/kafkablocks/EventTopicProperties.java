...
import org.kafkablocks.utils.ClassUtils;
import org.kafkablocks.utils.KafkaUtils;
...
public class EventTopicProperties extends AppProperties {
    ...
    @Getter
    @Setter
    private String packageName = "ru.croc.whswd.events.impl";
